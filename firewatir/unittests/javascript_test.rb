...
#    include FireWatir::Dialog
    ...
    def test_alert
        ...
        assert_equal("You pressed the Alert button!", browser.text_field(:id, "testResult").value)
    ...
    def test_ok_selectbox
        ...
        assert_equal("You pressed OK button", browser.text_field(:id, "txtAlert").value)
        assert_equal("Press OK", browser.get_popup_text)
    end
end
